...
# Author ID: mshrestha8
# Author Name: Manik Shrestha
...
class Student:
    ...
    def __init__(self, name, number):
        self.name = name
        self.number = str(number)  # Change type so that error doesn't happen
        self.courses = {}
    ...
    def displayGPA(self):
        if len(self.courses) == 0:
            return 'GPA of student ' + self.name + ' is 0.0'  # When no courses are added
        gpa = 0.0
